...
parser.add_argument("--log_dir", default='./log/gender_400/', type=str, dest="log_dir")
parser.add_argument("--result_dir", default="./result/gender_400/", type=str, dest="result_dir")
...
parser.add_argument('--n_labeled', default=400, type=int, dest="n_labeled")
parser.add_argument('--lambda_u', default=250, dest="lambda_u")
parser.add_argument('--alpha', default=0.25, dest="alpha")
