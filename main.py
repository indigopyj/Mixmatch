...
parser.add_argument("--log_dir", default='./log/SVHN_extra_250/', type=str, dest="log_dir")
parser.add_argument("--result_dir", default="./result/SVHN_extra_250/", type=str, dest="result_dir")
...
parser.add_argument('--n_labeled', default=250, dest="n_labeled")
