...
parser.add_argument("--checkpoint", default='./result/cifar500/checkpoint0.pth.tar', type=str, dest="checkpoint")
parser.add_argument("--log_dir", default='./log/cifar500/', type=str, dest="log_dir")
parser.add_argument("--result_dir", default="./result/cifar500/", type=str, dest="result_dir")
...
parser.add_argument('--n_labeled', default=500, dest="n_labeled")
