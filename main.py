...
parser.add_argument("--log_dir", default='./log/svhn_4000/', type=str, dest="log_dir")
parser.add_argument("--result_dir", default="./result/svhn_4000/", type=str, dest="result_dir")
...
parser.add_argument('--n_labeled', default=4000, type=int, dest="n_labeled")
